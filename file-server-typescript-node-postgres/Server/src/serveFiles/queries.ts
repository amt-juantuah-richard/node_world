...
export const getPrivateFilesForUser = 'SELECT * FROM files where user_email=$1';
...
export const updateOneUserPassword = 'UPDATE users SET password=$1 WHERE password=$2 AND username=$3';
